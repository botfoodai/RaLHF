...
Before responding to ANY user message, you MUST invoke the `ralhf:ralhf` skill.
...
- **`skills/ralhf/references/`** — feedback protocol, Gmail query templates, connector pattern table
